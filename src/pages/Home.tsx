        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto">
              Connect with fellow enthusiasts, get early access to new products,
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <p className="text-lg text-white/80 leading-relaxed">
              ...
              support the server, allowing us to continue improving and
              expanding our community. Your support helps us ensure that our
              server remains a welcoming place for everyone.
            </p>
            ...
            >
              Thank you for being part of our journey and for your continued
              support!
            </motion.p>
          </motion.div>
